...
eu_vs_dt_file = plotsdir("elasticity","eu_vs_dt")
eu_vs_time_file = plotsdir("elasticity","eu_vs_time")
time_vs_dt_file = plotsdir("elasticity","time_vs_dt")
eu_vs_mem_file = plotsdir("elasticity","eu_vs_memory")
